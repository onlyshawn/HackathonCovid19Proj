...
metric_basic = ['acc']
metric_ad = ['MCC', 'F1_score', 'precision', 'recall', 'Kappa', 'balanced_accuracy']
avg = ['micro', 'macro']
classes = len(dic)
...
if __name__ == '__main__':
    ...
    out_f_ad = {'F1_score': None, 'MCC': None, "AUC_ROC": None, "Kappa": None,  'precision':None, 'recall':None,
