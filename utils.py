...
def metric_advanced(mode, y_pred, labels):
    ...
    print()
    if (mode=="F1_score"):
        result = metrics.f1_score(y_test, y_pred, labels=labels, average="weighted")

    elif (mode=="precision"):
        result = metrics.precision_score(y_test, y_pred, labels=labels, average="weighted")

    elif (mode=="recall"):
        result = metrics.recall_score(y_test, y_pred, labels=labels, average="weighted")
